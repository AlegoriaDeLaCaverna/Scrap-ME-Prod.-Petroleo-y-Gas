...
if st.button("Procesar Datos y Generar Excel", type="primary"):
    ...
    ws.cell(row=fila_notas + 3, column=1, value="• Aclaración: Los conceptos incluidos en estos datos no contemplan la extracción 'No Convencional' en ninguno de los casos.")
    ...
    # El gráfico solo referenciará la data, sorteando las 5 filas de texto del pie
