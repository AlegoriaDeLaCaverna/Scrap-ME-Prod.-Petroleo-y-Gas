...
with col2:
    ...
    # El toque magistral: Selección múltiple de empresas para fusiones analíticas
...
if st.session_state.procesar_clicked:
    ...
    # Lógica de consolidación corporativa
    ...
    if se_puede_desglosar:
        ...
        # La tabla dinámica automáticamente suma los aportes de Trébol y Phoenix en el mismo mes
        ...
        # El groupby también suma de forma transparente cualquier cantidad de empresas elegidas
    ...
    chart = LineChart()
    chart.title = f"{nombre_fluido} - {nombre_empresa_reporte} ({acronimo_final})"
    chart.style = 13
    chart.width = 24  
    chart.height = 12 
    ...
    # Seguridad adicional contra nombres de archivo infinitamente largos
    if len(nombre_empresa_limpio) > 30:
        nombre_empresa_limpio = "Consorcio_Consolidado"
