...
st.markdown("Datos crudos y sin intermediarios extraídos del Ministerio de Energía.")
...
# El caché evita descargar el CSV cada vez que el usuario aprieta un botón
...
if st.button("Procesar Datos y Generar Excel", type="primary"):
    ...
    if se_puede_desglosar:
        df_agrupado['Total Consolidado'] = df_agrupado[cols_grafico].sum(axis=1)
